...
class PolynomialTest {
    ...
    public void testToStringUnique1() {
        ...
        assertEquals("Empty list of terms INCORRECT", "0", (Object) test.toString());
        ...
        for(int i = 0; i < UNIQUE_TERMS1.length; i++) {
            ...
            assertEquals("Expected and actual polynomial toString DON'T match", expected, (Object) actual);
        }
    }
